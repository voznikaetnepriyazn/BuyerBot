...
namespace TestProject1
{
    ...
    {
        [TestMethod]
        public async Task GetListOfGoodByBrand_Success()
        {
            //Arrange
            var good = new Good()
            {
            ...
            ServiseMock.Setup(x => x.GetListOfGoodsByBrand(It.IsAny<Guid>()));
        ...
        [TestMethod]
        public async Task GetListOfGoodByBrand_IdNotFound_BadRequest()
        {
            //Arrange
            var good = new Good()
            {
        ...
        [TestMethod]
        public async Task GetListOfGoodByBrand_ExeptionInside_Status500()
        {
            //Arrange
            var good = new Good()
            {
